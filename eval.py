...
def eval():
    ...
    if args.data == 'SMART':
        ...
        if args.experiment != "code_gen_ft":
            test_loader = get_geo3k_dataset(args, processor)
        else:
    ...
    if args.experiment != "code_gen_ft":
        ...
        code_generate(args, model, processor, train_loader, valid_loader, test_loader)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pseudo_code_type", type=str, default='GT') # [None, GT, schema_head]
