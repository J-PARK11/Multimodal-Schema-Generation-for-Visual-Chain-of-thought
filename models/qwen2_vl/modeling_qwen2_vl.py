...
class Qwen2VLForConditionalGeneration(Qwen2VLPreTrainedModel):
    ...
    def forward(
        ...
        if hidden_states.shape[1] != 1:
            ...
            # CA2
            weighted_pseudo_emb, attention_map1 = self.MCA1(query_psuedo_emb, key_img_dcp_emb, key_img_dcp_emb)
            weighted_pseudo_emb, attention_map2 = self.MCA2(weighted_pseudo_emb, key_img_dcp_emb, key_img_dcp_emb)
            weighted_pseudo_emb, attention_map3 = self.MCA3(weighted_pseudo_emb, key_img_dcp_emb, key_img_dcp_emb)
            weighted_pseudo_emb = weighted_pseudo_emb.to(image_mask.device)                        
            ...
            for i in range(B):
                ...
                pseudo_start_idx = (input_ids[i] == self.quad_start).nonzero()[0]
                pseudo_end_idx = (input_ids[i] == self.quad_end).nonzero()[0]
                len_pseudo_token = int(pseudo_end_idx-pseudo_start_idx-1)
                hidden_states[i][pseudo_start_idx+1:pseudo_end_idx] = weighted_pseudo_emb[i][:len_pseudo_token]
        ...
        return Qwen2VLCausalLMOutputWithPast(
            ...
            attentions=outputs.attentions, # outputs.attentions, attention_map3
